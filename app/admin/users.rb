ActiveAdmin.register User do
  ...
  controller do
    before_filter :get_user,            :only => [:roles, :roles_do, :comment, :comment_do]
    ...
    before_filter :can_certify,         :only => [:certify, :certify_do, :abandon_certification, :comment, :comment_do]
